              ...
              <ul>
                {ALL_PRODUCTS.map((category) => (
                  <li
                    ...
                    <div className='grid grid-cols-1 gap-y-10 gap-x-4'>
                      {category.featured.map((item) => (
                        <div
                          key={item.name}
                          className='flex items-center gap-4 relative text-sm'>
                          ...
                          <Link
                            ...
                            {item.name}  &rarr;
                            <br />
                           <span className='text-gray-400 font-normal'> Shop now</span>
                          </Link>
                        </div>
                      ))}
                    </div>
